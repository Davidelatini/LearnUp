  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-white/80 border border-blue-100 backdrop-blur-md rounded-full px-4 py-2 mb-8 text-sm text-slate-700 font-semibold shadow-lg">
        ...
        {/* Subheading */}
        <p className="text-lg sm:text-xl text-slate-900 font-semibold max-w-2xl mx-auto mb-10 leading-relaxed"
          style={{ textShadow: '0 1px 8px rgba(255,255,255,0.95), 0 0 20px rgba(255,255,255,0.8)' }}
        >
          Creiamo corsi e-learning, gestiamo il tuo LMS Moodle, sviluppiamo applicativi didattici
          e produciamo tutti i materiali formativi.{' '}
          <span className="bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent font-extrabold">
            Una soluzione completa, un solo partner.
          </span>
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-xl text-base transition-all hover:scale-105 hover:shadow-xl hover:shadow-blue-500/40 shadow-lg">
            Richiedi consulenza gratuita
          </button>
          <button
            onClick={() => setShowDemo(true)}
            className="w-full sm:w-auto bg-white/80 hover:bg-white border-2 border-blue-200 hover:border-blue-400 text-slate-800 font-semibold px-8 py-4 rounded-xl text-base transition-all backdrop-blur-sm flex items-center justify-center gap-2 shadow-md"
          >
